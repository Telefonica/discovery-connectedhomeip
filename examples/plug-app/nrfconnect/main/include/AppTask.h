...
private:
    ...
    static void ActionInitiated(PWMDevice::Action_t aAction, int32_t aActor, chip::EndpointId endpointId);
    static void ActionCompleted(PWMDevice::Action_t aAction, int32_t aActor, chip::EndpointId endpointId);
